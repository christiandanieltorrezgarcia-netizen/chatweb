...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.chuchogramapp\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [28 x i8] c"libaot-ChuchoGramApp.dll.so\00", align 1
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [39 x i8] c"libaot-Plugin.LocalNotification.dll.so\00", align 1
...
@.DSOCacheEntry.55_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 1
