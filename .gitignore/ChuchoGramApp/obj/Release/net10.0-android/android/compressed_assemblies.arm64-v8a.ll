...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [128 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12622216; uint32_t buffer_offset
	}, ; 125: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 21536, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12793224; uint32_t buffer_offset
	}, ; 126: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2058240, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12814760; uint32_t buffer_offset
	} ; 127: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14873000, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14873000 x i8] zeroinitializer, align 1
